...
export const galleryItems: GalleryItem[] = [
  { id: "country-loaf", category: "Sourdough", title: "The first loaf", description: "A slow look at the country loaf in first light.", mediaType: "video", src: "/assets/videos/the-first-loaf.mov", tone: "ivory", aspect: "portrait" },
  ...
  { id: "brown-butter", category: "Cookies", title: "Brown butter moment", description: "A warm cookie pulled apart at the perfect moment.", mediaType: "video", src: "/assets/videos/brown-butter-pull-apart.mov", tone: "beige", aspect: "square" },
  { id: "morning-pastry", category: "Pastries", title: "First-light pastry", description: "Laminated dough and the quiet work behind the case.", mediaType: "video", src: "/assets/videos/the-fold.mov", tone: "ivory", aspect: "landscape" },
